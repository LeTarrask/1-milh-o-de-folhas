...
let middlers = ["Opostos incompatíveis se destroem", "Com a selvagem paz de entender a língua dos homens e dos anjos,", "E no entanto a vida flui.", "Mas o humilde monge não tem nada a dizer.", "A espuma da onda vira terra e vira mar", "O vento levará tudo, grão a grão.", "Não duvido da incerteza permanente.", "A cor tatuada no vento indica a direção perfeita.", "Ao juntar-se a outra corrente de ar, adquire mais força.", "A base é mais forte do que o regente no topo.", "Raízes não impedem a árvore de crescer", "A chuva molha para elevar-se outra vez.", "Exceto se não tiver medo da companhia do fogo", "Quem chega ao céu por vontade própria", "Dentro do vale tudo é temporário, menos o tempo.", "Amorosas, as montanhas se eternizam", "A mente se fecha e o coração se abre", "A força vem dos pequenos gestos", "Dentro da terra, a semente espera", "As nossas histórias pertencem à toda a raça", "Cruzar a fronteira não significa nenhum esforço.", "Quem se retira nunca é vencido pela velocidade.", "Veloz, o relâmpago acende a beleza da vida.", "No topo, o pequeno grão de areia é soberano.", "Quem não queima não brilha", "Não são capazes de apagar o fogo", "A espera será frutífera.", "Escuta os olhos se apertarem", "Uma rocha impassível se quebra", "Por instante que dura uma eternidade", "Quem tivesse o maior tesouro da humanidade", "Antes do golpe fatal que os derrota", "Porque controla o seu próprio fogo", "Queima e alimenta-se de suas vítimas", "Não há encaixe entre imperfeitos", "São todos feitos na hora da exaustão.", "Há muito mais dúvidas quando alguém se olha no espelho", "A imóvel estátua dança", "Pronto para devorar o mundo", "O mundo inteiro colherá", "Que só o novo pode ser criado.", "Mais forte do que o universo:", "Uma biblioteca de infinitas combinações.", "Antes de explodir, a pólvora é pó cinzento e morto.", "Superior à força da rocha.", "A violenta espera pelo fim da guerra", "O que o tempo nos dá, toma", "Carregando todas as minhas crenças de infância", "O universo em um biscoito", "Captura a leveza do vento com o olhar", "Carrega a chama secreta", "Evaporando pelo infinito", "Só há um delicado caminho entre os dois:", "Não podem ter absolutamente nada em comum,", "Nada é criado sem conflito", "É o estado do som", "Quebram o meu silêncio", "A chuva invade o lago com gotas lancinantes", "O humilde sábio beija o chão sereno e agradecido", "Teus olhos só brilham quando queima o desejo.", "Jurei nunca mais subir naquela montanha-russa", "Através de marcas que expõem passados", "É um mistério para todos aqueles que evitam a luta", "Só há dúvidas no coração do guerreiro", "O acólito, o ritual ou o silêncio?", "Rufam tambores e asas de borboleta.", "é um espelho", "Na escuridão completa, o sábio reflete", "Discípulo sábio, mestre fraco.", "Liberdade vicia. Amor prende. Paixão mata. Distância aproxima. Gritos silenciam."]
